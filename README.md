...
get the app created:
    ...
    $ heroku apps:create junake
    Creating junake... done, stack is cedar
    http://junake.herokuapp.com/ | git@heroku.com:junake.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://junake.herokuapp.com deployed to Heroku

    To git@heroku.com:junake.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://junake.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@junake.herokuapp.com/repl
